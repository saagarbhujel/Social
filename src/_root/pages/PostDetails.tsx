    ...
    <div className="post_details-container">
      <div className="hidden md:flex max-w-5xl w-full">
        <Button onClick={()=>(navigate(-1))}>
          <img src="/assets/icons/back.svg"  width={24}
            height={24} alt="back" />
          ...
          <div className="flex-between w-full">
            ...
            >
              ...
              <div className="flex flex-col">
                <p className="base-medium lg:body-bold text-light-1 first-letter:capitalize">
                  {post?.creater.name}
                </p>
            ...
            <div className="flex-center gap-4">
              ...
              <Button onClick={handleDeletePost} variant={'ghost'} className={`ost_details-delete_btn ${user.id !== post?.creater.$id && "hidden"}`}>
